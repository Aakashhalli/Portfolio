...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="h-screen flex flex-col justify-center items-start px-8 md:px-16 lg:px-24 relative overflow-hidden"
    >
      <div className="max-w-3xl z-10">
        <motion.p
          className="text-secondary mb-3 font-medium text-2xl"
        ...
        >
          A passionate Computer Science Engineering student at KLE Technological
          University, MSSCET Campus, Belagavi. Curiosity to explore innovative
          technologies, I'm on a journey to sharpen my skills and contribute
          meaningfully to the tech world. I believe in the power of
